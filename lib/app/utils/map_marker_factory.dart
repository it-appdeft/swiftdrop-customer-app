...
class MapMarkerFactory {
  ...
  static Future<BitmapDescriptor> restaurantPin(String? imageUrl) =>
      _photoPin(
        cacheKey: 'restaurant::v4::${imageUrl ?? 'fallback'}',
        imageUrl: imageUrl,
        fallbackAsset: Assets.images.restaurantImage.path,
        ring: AppColors.primary,
      );

  static Future<BitmapDescriptor> driverPin(String? imageUrl) => _photoPin(
        cacheKey: 'driver::v4::${imageUrl ?? 'fallback'}',
        imageUrl: imageUrl,
        fallbackAsset: Assets.images.deliveryPartner.path,
        ring: AppColors.warning,
      );

  static Future<BitmapDescriptor> homePin() => _iconPin(
        cacheKey: 'home::v4',
        assetPath: Assets.images.home.path,
        ring: AppColors.lightSurfaceNavy,
      );
